...
- Dành cho **người dùng chạy ứng dụng (GUI, mô hình)**:  
  `pip install -r requirements.txt`

- Dành cho **lập trình viên hoặc cần chạy notebook**:  
...
- Mô hình Random Forest được huấn luyện và lưu tại:
  - `deployment/rforest_model.pkl`
...
- Để tạo file `.exe`, chỉ cần chạy lệnh:  
...
##  Đóng góp
Mọi đóng góp, phản hồi hoặc câu hỏi xin gửi về: kietlearntocode@gmail.com
